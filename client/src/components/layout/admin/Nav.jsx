...
export default function AdminNav() {
  ...
  const isInTheChatPage = pathname.startsWith("/admin/chats/");
  ...
  return (
    <div
      className={
        isInTheChatPage
          ? "navbar nav-bar bg-white sticky top-0 hidden sm:flex  px-3 sm:px-10 z-[100] "
          : "navbar nav-bar bg-white sticky top-0  px-3 sm:px-10 z-[100] "
      }
    >
      ...
      <div className="flex-1  flex justify-start  sm:justify-end gap-5  md:gap-10">
        <div className="flex  flex-none justify-between sm:justify-end w-full sm:gap-4 md:gap-10">
          <span
            onClick={() => navigate("/")}
            className="btn sm:hidden  scale-90 bg-gray-200 border-none md:scale-100 btn-circle"
          >
            <FaHome size={30} color="#316FF6" />
          </span>
          <span
            onClick={() => navigate("/admin/chats")}
            className="btn  scale-90 bg-gray-200 border-none md:scale-100 btn-circle"
          >
          ...
          <span
            onClick={() => setSearchbar(true)}
            className="btn  scale-90 bg-gray-200 border-none md:scale-100 btn-circle md:hidden"
          >
